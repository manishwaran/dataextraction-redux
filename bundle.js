...
/***/ function(module, exports, __webpack_require__) {
	...
	var _containerAppJs = __webpack_require__(157);

	var _containerAppJs2 = _interopRequireDefault(_containerAppJs);

	document.addEventListener('DOMContentLoaded', function () {
	  _react2['default'].render(_react2['default'].createElement(_containerAppJs2['default'], null), document.getElementById("container"));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DataExtractionApp = __webpack_require__(182);

	var _DataExtractionApp2 = _interopRequireDefault(_DataExtractionApp);
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          { store: store },
	          function () {
	            return _react2['default'].createElement(_DataExtractionApp2['default'], null);
	          }
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCombineReducers = __webpack_require__(161);

	var _utilsCombineReducers2 = _interopRequireDefault(_utilsCombineReducers);

	var _utilsBindActionCreators = __webpack_require__(164);

	var _utilsBindActionCreators2 = _interopRequireDefault(_utilsBindActionCreators);

	var _utilsApplyMiddleware = __webpack_require__(165);

	var _utilsApplyMiddleware2 = _interopRequireDefault(_utilsApplyMiddleware);

	var _utilsCompose = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsIsPlainObject = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsMapValues = __webpack_require__(162);

	var _utilsMapValues2 = _interopRequireDefault(_utilsMapValues);

	var _utilsPick = __webpack_require__(163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _compose = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsCreateAll = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createProvider = __webpack_require__(169);

	var _createProvider2 = _interopRequireDefault(_createProvider);

	var _createProvideDecorator = __webpack_require__(171);

	var _createProvideDecorator2 = _interopRequireDefault(_createProvideDecorator);

	var _createConnector = __webpack_require__(173);

	var _createConnector2 = _interopRequireDefault(_createConnector);

	var _createConnectDecorator = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCreateStoreShape = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsGetDisplayName = __webpack_require__(172);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqual = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqualScalar = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dataExtractReducer = __webpack_require__(180);

	exports.dataExtractState = _interopRequire(_dataExtractReducer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function dataExtract(state, action) {
	  ...
	  switch (action.type) {
	    ...
	    case types.CLOSE:
	      return _extends({}, state, {
	        jsonInput: state.jsonInput.slice(0, action.index).concat(state.jsonInput.slice(action.index + 1, Object.keys(state.jsonInput).length))
	      });
...
/***/ function(module, exports) {
	...
	var LOAD_URL = 'LOAD_URL';
	exports.LOAD_URL = LOAD_URL;
	var IFRAME_CLICK = 'IFRAME_CLICK';
	exports.IFRAME_CLICK = IFRAME_CLICK;
	var ADD = 'ADD';
	exports.ADD = ADD;
	var EXECUTE = 'EXECUTE';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsDataExtractAction = __webpack_require__(183);

	var DataExtractActions = _interopRequireWildcard(_actionsDataExtractAction);

	var _componentsUrlBoxJsx = __webpack_require__(184);

	var _componentsUrlBoxJsx2 = _interopRequireDefault(_componentsUrlBoxJsx);

	var _componentsResultBoxJsx = __webpack_require__(186);

	var _componentsResultBoxJsx2 = _interopRequireDefault(_componentsResultBoxJsx);

	var _componentsLeftPanelJsx = __webpack_require__(187);

	var _componentsLeftPanelJsx2 = _interopRequireDefault(_componentsLeftPanelJsx);

	var _componentsIframeJsx = __webpack_require__(189);

	var _componentsIframeJsx2 = _interopRequireDefault(_componentsIframeJsx);

	var _componentsAppendItemJsx = __webpack_require__(188);

	var _componentsAppendItemJsx2 = _interopRequireDefault(_componentsAppendItemJsx);

	var _componentsUtilsCssPath = __webpack_require__(190);

	var _componentsUtilsCssPath2 = _interopRequireDefault(_componentsUtilsCssPath);

	var DataExtractionApp = (function (_React$Component) {
	  _inherits(DataExtractionApp, _React$Component);

	  function DataExtractionApp() {
	    _classCallCheck(this, _DataExtractionApp);

	    _get(Object.getPrototypeOf(_DataExtractionApp.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(DataExtractionApp, [{
	    key: 'render',
	    value: function render() {
	      ...
	      var dataExtractState = _props.dataExtractState;
	      var dispatch = _props.dispatch;

	      var actions = (0, _redux.bindActionCreators)(DataExtractActions, dispatch);
	      return _react2['default'].createElement(
	        'div',
	        null,
	        _react2['default'].createElement(
	          'div',
	          { className: 'row' },
	          _react2['default'].createElement(_componentsUrlBoxJsx2['default'], { load: actions.loadUrl, val: dataExtractState.url })
	        ),
	        _react2['default'].createElement(
	          'div',
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'div',
	              { className: 'row' },
	              _react2['default'].createElement(_componentsIframeJsx2['default'], { onSelect: actions.iframeClick })
	            ),
	            _react2['default'].createElement(
	              'div',
	              { className: 'row' },
	              _react2['default'].createElement(_componentsResultBoxJsx2['default'], { result: dataExtractState.jsonOutput })
	            )
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'col col-lg-4' },
	            _react2['default'].createElement(_componentsLeftPanelJsx2['default'], { jsonData: dataExtractState.jsonInput, actions: actions })
	          )
	        )
	      );
	    }
	    ...
	    value: {
	      ...
	      rawData: _react.PropTypes.string.isRequired,
	      jsonInput: _react.PropTypes.object.isRequired,
	      jsonOutput: _react.PropTypes.object.isRequired,
	      dispatch: _react.PropTypes.func.isRequired
	    },
	    enumerable: true
	  }]);

	  var _DataExtractionApp = DataExtractionApp;
	  DataExtractionApp = (0, _reactRedux.connect)(function (state) {
	    return {
	      dataExtractState: state.dataExtractState
	    };
	  })(DataExtractionApp) || DataExtractionApp;
	  return DataExtractionApp;
	})(_react2['default'].Component);

	exports['default'] = DataExtractionApp;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.add = add;
	exports.iframeClick = iframeClick;
	exports.execute = execute;
	exports.clear = clear;
	exports.close = close;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UrlBox = (function (_React$Component) {
	  ...
	  function UrlBox(props) {
	    ...
	    _get(Object.getPrototypeOf(UrlBox.prototype), 'constructor', this).call(this, props);
	    this.state = {
	      url: ""
	    };
	  }
	  ...
	  _createClass(UrlBox, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'form',
	        { id: 'myform', className: 'well clearfix' },
	        _react2['default'].createElement(
	          'div',
	          { className: 'col-lg-7 col-sm-7' },
	          _react2['default'].createElement('input', { id: 'urlBox', className: 'form-control', onChange: this.handleChange.bind(this), value: this.state.url })
	        ),
	        _react2['default'].createElement(
	          'button',
	          { className: 'btn btn-primary pull-left', onClick: this.submitUrl.bind(this) },
	          'Load Url'
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResultBox = (function (_React$Component) {
	  _inherits(ResultBox, _React$Component);

	  function ResultBox(props) {
	    _classCallCheck(this, ResultBox);

	    _get(Object.getPrototypeOf(ResultBox.prototype), 'constructor', this).call(this, props);
	  }

	  _createClass(ResultBox, [{
	    key: 'render',
	    value: function render() {
	      var createDivision = function createDivision(item, i) {
	        return _react2['default'].createElement(
	          'div',
	          null,
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'div',
	              { className: 'badge', style: { padding: 10 } },
	              'Result :',
	              i + 1
	            ),
	            _react2['default'].createElement(
	              'div',
	              { className: 'label label-info', style: { padding: 10 } },
	              '  ',
	              item.val,
	              ' '
	            )
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'row panel panel-heading', id: 'result' },
	    ...
	    key: 'propTypes',
	    value: {
	      result: _react.PropTypes.array.isRequired
	    },
	    enumerable: true
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppendItemJsx = __webpack_require__(188);

	var _AppendItemJsx2 = _interopRequireDefault(_AppendItemJsx);

	var LeftPanel = (function (_React$Component) {
	  _inherits(LeftPanel, _React$Component);

	  function LeftPanel(props, context) {
	    _classCallCheck(this, LeftPanel);

	    _get(Object.getPrototypeOf(LeftPanel.prototype), 'constructor', this).call(this, props, context);
	  }
	  ...
	  _createClass(LeftPanel, [{
	    ...
	    value: function render() {
	      ...
	      var createDivision = function createDivision(item, i) {
	        return _react2['default'].createElement(
	          'div',
	          { id: "append" + i, className: 'append-box' },
	          _react2['default'].createElement(
	            'div',
	            { id: 'close', style: { float: 'right', color: 'red' }, onClick: function () {
	                return _this.props.actions.close.bind(null, i);
	              } },
	            'close'
	          ),
	          _react2['default'].createElement(_AppendItemJsx2['default'], { item: item })
	        );
	      };
	      return _react2['default'].createElement(
	        'div',
	        ...
	        _react2['default'].createElement(
	          'button',
	          { className: 'btn btn-default', onClick: this.props.actions.add, style: { margin: 10 } },
	          ' + '
	        ),
	        _react2['default'].createElement(
	          'button',
	          { className: 'btn btn-primary', onClick: this.props.actions.execute, style: { margin: 10 } },
	          ' Execute '
	        ),
	        _react2['default'].createElement(
	          'button',
	          { className: 'btn btn-primary', onClick: this.props.actions.clear, style: { margin: 10 } },
	          ' Clear '
	        ),
	    ...
	    key: 'propTypes',
	    value: {
	      jsonData: _react.PropTypes.array.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppendItem = (function (_React$Component) {
	  _inherits(AppendItem, _React$Component);

	  function AppendItem() {
	    _classCallCheck(this, AppendItem);

	    _get(Object.getPrototypeOf(AppendItem.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(AppendItem, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement('input', { className: 'col-lg-6 pull-left', type: 'text', name: 'css-input', id: 'css-input', value: this.props.item.css })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'row', style: { padding: 5 } },
	            ...
	            _react2['default'].createElement('input', { className: 'col-lg-6 pull-left', type: 'text', name: 'attr-input', id: 'attr-input', value: this.props.item.attr })
	          )
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCssPath = __webpack_require__(190);

	var _utilsCssPath2 = _interopRequireDefault(_utilsCssPath);

	var Iframe = (function (_React$Component) {
	  _inherits(Iframe, _React$Component);

	  function Iframe(props, context) {
	    _classCallCheck(this, Iframe);

	    _get(Object.getPrototypeOf(Iframe.prototype), 'constructor', this).call(this, props, context);
	    this.onFrameLoaded = this.onFrameLoaded.bind(this);
	  }

	  _createClass(Iframe, [{
	    key: 'onFrameLoaded',
	    value: function onFrameLoaded(frame) {
	      var that = this;
	      $(frame).contents().click(function (e) {
	        var output = {};
	        var cssSelector = (0, _utilsCssPath2['default'])(e.target, $);
	    ...
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement('iframe', { ref: this.onFrameLoaded, className: 'col col-lg-12', height: '700px', allowfullscreen: '', id: 'myIframe', sandbox: 'allow-same-origin allow-scripts' });
	    }
	  }], [{
	    key: 'propTypes',
	    value: {
	      rawData: _react.PropTypes.string,
...
/***/ function(module, exports) {
	...
	var classSelector = function classSelector(className) {
	  ...
	  array = selectors.map(function (selector) {
	    if (['starfire-tagger-active', 'starfire-tagger-active-multi', 'starfire-tagger-selected'].includes(selector)) return '';else if (selector.length > 0) return '.' + selector;
	    return '';
	  });
	  return array.join('');
	};
	...
	var _cssPath = function _cssPath(_x, _x2, _x3) {
	  var _again = true;
	  ...
	  _function: while (_again) {
	    ...
	    if (tag !== 'html' && tag !== 'body' && elm.parentNode) {
	      ...
	      if (!isUnique(list)) {
	        ...
	        _x3 = list;
	        _again = true;
	        isUnique = tag = selector = className = id = isUniqueToParent = undefined;
	        continue _function;
	      }
	    }
	...
	var getCommonCssPath = function getCommonCssPath(css1, css2) {
	  return cssPathToString(css1.filter(function (selector, index) {
	    return selector === css2[index];
	  }));
	};

	exports.getCommonCssPath = getCommonCssPath;
	var cssPath = function cssPath(elm, $) {
	  return _cssPath(elm, $, []);
	};
